...
export const CASES: CaseInfo[] = [
  {
    ...
    description:
      'Вместе с московским НИИПом сделали мобильное приложение для беспроводного управления дозиметром. Работники могут подключать устройство и удобно просматривать информацию на экране своего телефона.\n\n«Мой дозиметр» есть в RuStore! Можно скачать и проверить функционал на демо-устройстве',
